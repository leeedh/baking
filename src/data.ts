import { ClassItem, CurriculumChapter, Review, KPIStats, ClassManagementItem } from './types';
...
export const CLASSES_DATA: ClassItem[] = [
  {
    ...
    description: '프랑스 정통 제과의 비밀을 속속들이 파헤칩니다. 마카롱 꼬끄의 완벽한 피에(Foot)를 올리는 머랭 온도 제어법부터 바닐라 무슬린 크림, 무화과 콩피츄르, 초콜릿 가나슈 필링의 정교한 밸런싱까지 전수합니다. 타이베이와 서울의 마스터 오디토리엄에서 극찬을 받은 하이엔드 테크닉을 집에서 평생 소장하며 마스터하세요.',
    price: 189000,
    originalPrice: 280000,
    rating: 4.9,
    reviewCount: 328,
    thumbnail: 'https://images.unsplash.com/photo-1569864358642-9d1684040f43?auto=format&fit=crop&q=80&w=1200',
    category: '정통 프렌치 디저트',
    level: '중급',
  ...
  },
  {
    ...
    description: '프랑스 고메 버터를 태우는 ‘헤이즐넛 버터(Beurre Noisette)’의 황금 온도와 깊은 풍미를 구현합니다. 속은 쫀득하고 겉은 극도로 바삭한 명품 구움과자의 텍스처를 완성하는 프로의 오븐 스케줄링. 카라멜 테라코타 포인트의 고급 클래식 터치를 가미한 크렘 오리지널 레시피 5종을 소개합니다.',
    price: 145000,
    originalPrice: 198000,
    rating: 4.8,
    reviewCount: 412,
    thumbnail: 'https://images.unsplash.com/photo-1607958996333-41aef7caefaa?auto=format&fit=crop&q=80&w=1200',
    category: '클래식 구움과자',
    level: '초급',
  ...
  },
  {
    ...
    description: '밀가루와 고메 버터가 완벽한 결을 이루는 파트 사블레(Pâte Sablée) 제작법부터 시작합니다. 입안 가득 크리미함을 남기는 클래식 크렘 파티시에와 카라멜라이징 피칸, 은은하게 풍기는 오렌지 블라썸의 우아한 마리아주. 대만 구르메 세션에서 매번 기립박수를 받은 아티스트 전용 아틀리에 커리큘럼.',
    price: 210000,
    originalPrice: 295000,
    rating: 5.0,
    reviewCount: 184,
    thumbnail: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&q=80&w=1200',
    category: '모던 타르트',
    level: '상급',
...
export const REVIEWS_DATA: Review[] = [
  {
    ...
    rating: 5,
    date: '2026.05.28',
    content: '대만 유학가기 전에 항상 디저트 공부하면서 애태웠던 머랭 조절을 이 강의로 완전 극복했어요! 꼬끄 밑면이 비는 현상(할로우)이 왜 일어나는지 정확한 이론으로 설명해주셔서 너무 통쾌합니다. 벌써 평생 소장 강의만 세 번 돌려봤네요.',
  ...
  },
  {
    ...
    rating: 5,
    date: '2026.05.15',
    content: '我在台北親自參加過謝芙的實體課，沒想到VOD影片解析度這麼高，甚至比在現場看還清晰！烤箱控溫的段落講解特別細緻，非常推薦給想要追求法式經典口感的烘焙愛好者！🥰',
  ...
  },
  {
    ...
    rating: 4,
    date: '2026.06.01',
    content: '카페 사이드 베이킹용으로 주문해서 수강중입니다. 손님들이 휘낭시에 먹어보더니 겉바속촉이 수준급이라고 칭찬하네요. 탄버터 거르는 팁 덕분에 구움색이 너무 예쁜 카라멜 빛깔로 구워져서 가판대 존재감이 엄청납니다.',
  ...
  },
  {
    ...
    rating: 5,
    date: '2026.06.07',
    content: '상급이라 확실히 정교한 계산과 감각이 많이 요구됩니다. 폰사주 할 때 매번 모서리가 찢어지던 설움이 싹 들어갔어요. 생또노레 카라멜 코팅할 때 손을 델까 봐 무서웠는데, 안전하고 고급스럽게 완성할 수 있는 팁 최고입니다!',
