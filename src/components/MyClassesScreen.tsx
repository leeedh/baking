...
export default function MyClassesScreen({ purchasedClassIds }: MyClassesScreenProps) {
  ...
  return (
    <div
      ...
      className="bg-[#FAF4EA] py-12 px-4 sm:px-8 max-w-7xl mx-auto min-h-[70vh]"
    >
      {/* Title */}
      <div className="mb-10 text-center sm:text-left">
        <span className="text-xs font-bold text-[#B0863C] tracking-widest uppercase block mb-1">
          My baking academy
        </span>
      ...
      {purchasedClasses.length === 0 ? (
        ...
        <div
          ...
          className="max-w-xl mx-auto bg-white rounded-2xl border border-[#EFE8DC] p-10 text-center space-y-6 shadow-md transform hover:scale-[1.01] transition-transform duration-300"
        >
          ...
          <div className="h-px bg-[#EFE8DC] my-4" />

          <div className="space-y-4">
            <span className="text-[10px] uppercase font-bold text-[#B65538] block tracking-widest">
              크렘의 추천 맛보기 코스
            </span>
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="text-xs font-bold text-[#2A211B] block truncate">
                  피에르 마카롱 마스터
                </span>
              </div>
              <div
                ...
                onClick={onNavigateToCatalog}
              >
                <span className="text-[10px] text-[#B65538] font-semibold block">
                  클래식 사블레
                </span>
                <span className="text-xs font-bold text-[#2A211B] block truncate">
                  카라멜 휘낭시에
