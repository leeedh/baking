...
export default function Footer() {
  return (
    <footer
      id="platform-footer"
      className="bg-[#2A211B] text-[#FAF4EA]/80 py-12 px-6 mt-auto border-t-4 border-[#B65538]"
    >
      <div
        id="footer-container"
      ...
      >
        <div className="md:col-span-2 space-y-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] bg-[#B0863C] text-[#2A211B] px-1.5 py-0.5 rounded font-sans font-bold">
              VOD STUDIO
            </span>
          </div>
